...
void D3D12HelloTriangle::OnInit() {
  ...
  nv_helpers_dx12::CameraManip.setLookat(
      glm::vec3(3.5f, 3.5f, 3.5f), glm::vec3(0, 0, 0), glm::vec3(0, 1, 0));
...
void D3D12HelloTriangle::LoadAssets() {
  // Create an empty root signature.
  {
    ...
    matricesRange.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1 /* desc count*/,
                       0 /*register t0 */, 0 /*space*/, 1 /*heap slot*/);
...
void D3D12HelloTriangle::CreateAccelerationStructures() {
  ...
  m_instances = {
      ...
      //{bottomLevelBuffers.pResult, XMMatrixTranslation(-.6f, 0, 0)},
      // #DXR Extra: Per-Instance Data
      {planeBottomLevelBuffers.pResult, XMMatrixTranslation(0, -0.8, 0)}};
...
void D3D12HelloTriangle::CreatePlaneVB() { 
  ...
  float col[] = { 0.8f, 0.4f, 0.3f, 1.0f };
  int factor = 2;
  int factor2 = 0;
  Vertex planeVertices[] = {
      {{-1.5f * factor, -.8f * factor2, 01.5f * factor}, {0.8f, 0.4f, 0.3f, 1.0f}}, // 0
      {{-1.5f * factor, -.8f * factor2, -1.5f * factor}, {0.8f, 0.4f, 0.3f, 1.0f}}, // 1
      {{01.5f * factor, -.8f * factor2, 01.5f * factor}, {0.8f, 0.4f, 0.3f, 1.0f}}, // 2
      {{01.5f * factor, -.8f * factor2, 01.5f * factor}, {0.8f, 0.4f, 0.3f, 1.0f}}, // 2
      {{-1.5f * factor, -.8f * factor2, -1.5f * factor}, {0.8f, 0.4f, 0.3f, 1.0f}}, // 1
      {{01.5f * factor, -.8f * factor2, -1.5f * factor}, {0.8f, 0.4f, 0.3f, 1.0f}}  // 4
  };
...
//
// #DXR Extra: Per-Instance Data
// void D3D12HelloTriangle::CreateGlobalConstantBuffer() commented
/*
...
void D3D12HelloTriangle::CreateMengerSpongeVB() {
  ...
  nv_helpers_dx12::GenerateMengerSponge(vertices, indices);
